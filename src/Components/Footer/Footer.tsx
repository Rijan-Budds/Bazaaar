      ...
      <div className="flex flex-wrap justify-between max-w-[1200px] mx-auto gap-7.5">
        <div className="company flex-grow flex-shrink basis-[250px]">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Buy, sell and discover amazing second-hand deals around you.
          </p>
        </div>

        <div className="flex-grow flex-shrink">
          <h4 className="text-lg font-semibold text-[#bb2649] mb-4">
            Quick Links
          </h4>
          <ul className="list-none p-0 m-0">
            <li>
              <a
                href="#"
                className="text-gray-600 no-underline transition-colors duration-200 hover:text-[#ff4d79]"
              >
                About Us
              </a>
            </li>
